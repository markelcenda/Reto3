		...
		.then(res => res.json()).then(result => {
				...
				for(var i=0; i<jugadores.length; i++){
					...
					if(jugadores[i].posicion=="Delantero"){
						...
						cardJugadores="<div class='col-lg-3 col-md-6 col-8 ml-3 mr-3'>" +
				                			  	"<div class='card'>" +
				...
				for(let i=0; i<entrenadores.length; i++){
					...
					cardEntrenadores="<div class='col-lg-3 col-md-6 col-8 ml-3 mr-3'>" +
					            			  	"<div class='card'>" +
					...
					cardDelegados="<div class='col-lg-3 col-md-6 col-8 ml-3 mr-3'>" +
					            			  	"<div class='card '>" +
